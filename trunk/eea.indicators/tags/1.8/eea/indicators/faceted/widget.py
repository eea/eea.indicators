...
class IndicatorsSorter(object):
    ...
    def reorder_brains_codes(self):
        # There is no good way of sorting a list of Specs where not all of them
        # belong to the same indicators set, so we need to differentiate this case. 
        #In this case we will sort them according to the first setcode that they present.
        codes = {}
